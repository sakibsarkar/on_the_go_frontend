import OntheGoTooltip from "@/components/shared/OntheGoTooltip";
import { reactionData } from "@/lib/postReactionData";
import { useChangePostReactionMutation } from "@/redux/features/reaction/reaction.api";
...
const PostReaction: React.FC<IProps> = ({ post }) => {
  ...
  const [changePostReaction] = useChangePostReactionMutation();
  ...
  const handleChange = async (reactionId: TReactionType) => {
    ...
    await changePostReaction(payload);
  };
